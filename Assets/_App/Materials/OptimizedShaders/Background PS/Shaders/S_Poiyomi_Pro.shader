Shader "Hidden/Locked/.poiyomi/★ Poiyomi Pro ★/Background PS-Background PS"
{
    Properties 
  { 
...
#define PROP_VERTEXGLITCHFREQUENCY 0.92
#define PROP_VERTEXGLITCHTHRESHOLD 0.792
#define PROP_VERTEXGLITCHSTRENGTH 5.3
