...
half4 fragShadowCaster(
    ...
    ): SV_Target
    {
        ...
        poiMesh.uv[2] = i.uv2;
        poiMesh.uv[3] = i.uv3;
        float4 mainTexture = UNITY_SAMPLE_TEX2D(_MainTex, TRANSFORM_TEX(poiMesh.uv[float(0)], _MainTex) + _Time.x * float4(0.3,0.3,0,0));
        ...
        poiCam.worldPos = _WorldSpaceCameraPos;
            ...
            alpha.a *= alphaMask;
            alpha.a *= float4(0.08898153,0.08898153,0.08898153,0).a + .0001;
            alpha.a += float(0);
